...
mH=$1
dir=/vols/cms/emc21/idmStudy/BPs/MadGraph_files/paramScan/mHDependence/mAmH10_mHchmH30
...
# for mH in 80 100 140 180 220; do qsub -q hep.q -cwd -l h_rt=24:0:0 -pe hep.pe 4 run_batch.sh ${mH} ; done