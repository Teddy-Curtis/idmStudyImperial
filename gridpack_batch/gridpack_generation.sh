...
cd /eos/user/e/ecurtis/idmStudy/genproductions/bin/MadGraph5_aMCatNLO
...
make_tarball () {
    ...
    echo "This the list of files in the directory:"
    pwd
    ls

    mkdir InputCards
    cp $CARDSDIR/${name}*.* InputCards
    echo "Just copied over the cards to InputCards"
    ...
    mkdir -p /eos/user/e/ecurtis/idmStudy/myFiles/gridpacks/h2h2lPlM_lem_scan/${name}/;

    mv ${PRODHOME}/${name}_${scram_arch}_${cmssw_version}_tarball.tar.xz /eos/user/e/ecurtis/idmStudy/myFiles/gridpacks/h2h2lPlM_lem_scan/${name}/
    mv ${PRODHOME}/${name}/ /eos/user/e/ecurtis/idmStudy/myFiles/gridpacks/h2h2lPlM_lem_scan/${name}/
    mv $LOGFILE /eos/user/e/ecurtis/idmStudy/myFiles/gridpacks/h2h2lPlM_lem_scan/${name}/
    echo "End of job"
