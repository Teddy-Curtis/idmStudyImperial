...
# Copy files over
mkdir -p ${OUTPATH}/Data/2022_postEE
xrdcp nanoAOD_${SEED}.root ${OUTPATH}/Data/2022_postEE/${run_name}_2022_postEE_nanoAOD_${SEED}.root
