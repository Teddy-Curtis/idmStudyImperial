...
if (( "$#" != "6" ))
    ...
    echo "./RunIISummer16_preVFP_nanoAOD.sh "
    exit
fi
...
xrdcp ${GRIDPACK} .
xrdcp ${FRAGMENT} .
xrdcp /afs/cern.ch/user/e/ecurtis/idmStudyImperial/MCproduction/PU_lists/pulist_16.txt .
...
# Copy files over
mkdir -p ${OUTPATH}/Data/Summer16_preVFPData
xrdcp nanoAOD_${SEED}.root ${OUTPATH}/Data/Summer16_preVFPData/${run_name}_Summer16_preVFPData_nanoAOD_${SEED}.root
