...
mkdir -p Summer16Data_preVFP
mv miniAOD_${SEED}.root Summer16Data_preVFP/.
mv nanoAOD_${SEED}.root Summer16Data_preVFP/.
mv /vols/cms/emc21/idmStudy/MCproduction/logging/qsub_2016preVFP_nanoAODproduction.sh.e${JOB_ID} Summer16Data_preVFP/.
mv /vols/cms/emc21/idmStudy/MCproduction/logging/qsub_2016preVFP_nanoAODproduction.sh.o${JOB_ID} Summer16Data_preVFP/.
mv LHE-GEN_cfg_${JOB_ID}.py Summer16Data_preVFP/.
mv PREMIX_cfg_${JOB_ID}.py Summer16Data_preVFP/.
mv HLT_cfg_${JOB_ID}.py Summer16Data_preVFP/.
mv AOD_cfg_${JOB_ID}.py Summer16Data_preVFP/.
mv miniAOD_cfg_${JOB_ID}.py Summer16Data_preVFP/.
mv nanoAOD_cfg_${JOB_ID}.py Summer16Data_preVFP/.
