...
NEVENTS=5
OUTPATH=root://eosuser.cern.ch//eos/user/e/ecurtis/idmFilesEOS/gridpacks/idm_dilepton_13p6_parameterscan_updatedWidths_CMSSW_12_4_8_newGen_SDEstrategy1/$(run_name)
                               
# arguments 
GRIDPACK=root://eosuser.cern.ch//eos/user/e/ecurtis/idmFilesEOS/gridpacks/idm_dilepton_13p6_parameterscan_updatedWidths_CMSSW_12_4_8_newGen_SDEstrategy1/$(run_name)/$(run_name)_$(scram_version)_$(CMSSW_version)_tarball.tar.xz
...
queue mH, mA from /afs/cern.ch/user/e/ecurtis/idmStudyImperial/MCproduction/newGenproductions/bin/MadGraph5_aMCatNLO/cards/test_cards/cards/13p6/test_arguments.txt
