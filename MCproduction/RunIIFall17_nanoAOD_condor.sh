...
xrdcp ${GRIDPACK} .
xrdcp ${FRAGMENT} .
xrdcp root://eosuser.cern.ch//eos/user/e/ecurtis/idmStudyImperial/MCproduction/pulist_Fall17.txt .
...
xrdcp nanoAOD_${SEED}.root ${OUTPATH}/Data/Fall2017Data/nanoAOD_${SEED}.root
