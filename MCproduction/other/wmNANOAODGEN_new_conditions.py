...
# with command line options: Configuration/GenProduction/python/general_config.py --fileout file:wmNANOAODGEN_new_conditions.root --mc --eventcontent NANOAODGEN --datatier NANOAOD --conditions 102X_mc2017_realistic_v8 --beamspot Realistic25ns13TeVEarly2017Collision --step LHE,GEN,NANOGEN --nThreads 1 --geometry DB:Extended --era Run2_2017,run2_nanoAOD_106Xv1 --python_filename wmNANOAODGEN_new_conditions.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring --customise_commands=process.add_(cms.Service('InitRootHandlers', EnableIMT = cms.untracked.bool(False))) -n 10000
import FWCore.ParameterSet.Config as cms

from Configuration.Eras.Era_Run2_2017_cff import Run2_2017
from Configuration.Eras.Modifier_run2_nanoAOD_106Xv1_cff import run2_nanoAOD_106Xv1

process = cms.Process('NANOGEN',Run2_2017,run2_nanoAOD_106Xv1)
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/general_config.py nevts:10000'),
...
process.NANOAODGENoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:wmNANOAODGEN_new_conditions.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/eos/user/e/ecurtis/idmStudy/myFiles/gridpacks/h2h2lPlM_lem/h2h2lPlM_lem_BP9/h2h2lPlM_lem_BP9_slc7_amd64_gcc700_CMSSW_10_6_19_tarball.tar.xz'),
