...
# with command line options: Configuration/GenProduction/python/general_config.py --fileout file:wmLHEGEN.root --mc --eventcontent NANOAODGEN --datatier NANOAOD --conditions 106X_mcRun2_asymptotic_v15 --beamspot Realistic25ns13TeVEarly2017Collision --step LHE,GEN,NANOGEN --nThreads 1 --geometry DB:Extended --era Run2_2017,run2_nanoAOD_106Xv1 --python_filename wmLHEGEN.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring --customise_commands=process.add_(cms.Service('InitRootHandlers', EnableIMT = cms.untracked.bool(False))) -n 10000
...
process.NANOAODGENoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:wmLHEGEN.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/eos/user/e/ecurtis/idmStudy/myFiles/gridpacks/h2h2lPlM_lem/h2h2lPlM_lem_BP14/h2h2lPlM_lem_BP14_slc7_amd64_gcc700_CMSSW_10_6_19_tarball.tar.xz'),
